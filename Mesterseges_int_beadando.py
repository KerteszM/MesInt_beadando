            ...
            if i==0:
                if r==0:
                    ...
                    for k in range(pauseNum):
                        if not checkPauses_and_currentWork(int(startMachine[jobsOrder[i]][r]),jobsArray[jobsOrder[i]][r],pauseArray,pauseNum,k):
...
def checkPauses_and_currentWork(time,workCurrent,pauseArray,pauseNum,i):
